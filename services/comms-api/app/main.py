...
# A comma-separated list can be provided via the `CORS_ORIGINS` environment
# variable to override/extend these defaults.
...
# Log the allowed origins – useful when inspecting Railway logs
